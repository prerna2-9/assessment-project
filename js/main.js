...
function anything(){
    ...
    // console.log(`${data}`);
    // console.log(`https://newsapi.org/v2/everything?q=${data}&language=en&apiKey=fabb056ff8594a2c9cd1ea680aa83aa7`);
   
    $.ajax({
        type:'GET',
        url:`https://newsapi.org/v2/everything?q=${data}&language=en&apiKey=fabb056ff8594a2c9cd1ea680aa83aa7`,
        success: function(data){
            console.log(data)
            let text = 'Read More';
